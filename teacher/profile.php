...
try {
    ...
    $_SESSION['error'] = 'Failed to load teacher data.';
    $teacher = [];
}
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt = $db->prepare("UPDATE users SET 
                                ...
                                WHERE id = ?");
            $stmt->execute([
                $name, $email, $phone, $address, $teacher_id
            ]);
    ...
    <div class="col-md-4 mb-4">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="fas fa-id-card me-2"></i>Teacher Information</h5>
            </div>
            <div class="card-body text-center">
                <img src="https://via.placeholder.com/150" alt="Teacher Profile" class="profile-img mb-3">
                ...
                <div class="text-start">
                    ...
                    <p><strong>Joined:</strong> <?php echo date('d M Y', strtotime($teacher['created_at'])); ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="email" id="email" class="form-control" value="<?php echo $teacher['email']; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="tel" name="phone" id="phone" class="form-control" value="<?php echo $teacher['phone']; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="address" class="form-label">Address</label>
                            <input type="text" name="address" id="address" class="form-control" value="<?php echo $teacher['address']; ?>">
                        </div>
                    </div>
